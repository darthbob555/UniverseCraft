...
public class ItemCondensedPaxel extends ItemTool 
{
	...
	public ItemCondensedPaxel(ToolMaterial material, String name)
	{
		super(3, material, blocks);
		setUnlocalizedName(UniverseCraft.MODID + "_" + "CondensedPaxel");
		setTextureName(UniverseCraft.MODID + ":" + "CondensedPaxel");
		setCreativeTab(UniverseCraft.universeCraft);
	}
	@Override
	public float getDigSpeed(ItemStack stack, Block block, int meta)
	{
		return block != Blocks.bedrock ? efficiencyOnProperMaterial : 1.5F;
	}
	@Override
