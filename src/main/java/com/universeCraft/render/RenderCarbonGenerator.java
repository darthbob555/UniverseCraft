...
public class RenderCarbonGenerator extends TileEntitySpecialRenderer{

	private ModelGenerator model;
	private ResourceLocation texture1 = new ResourceLocation("UniverseCraft:textures/blocks/CarbonGenerator.png");

	public RenderCarbonGenerator(){
