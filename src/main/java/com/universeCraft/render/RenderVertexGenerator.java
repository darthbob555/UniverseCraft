...
public class RenderVertexGenerator extends TileEntitySpecialRenderer{

	private ModelGenerator model;
	private ResourceLocation texture1 = new ResourceLocation("UniverseCraft:textures/blocks/SolarGenerator.png");

	public RenderVertexGenerator(){
