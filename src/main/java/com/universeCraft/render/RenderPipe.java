...
public class RenderPipe extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler{
	...
	public ResourceLocation texture1 = new ResourceLocation("UniverseCraft:textures/blocks/Pipe3D.png");
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelID, RenderBlocks renderer){
		if (modelID == renderId){
			//middle
			renderer.setRenderBounds(0.20f, 0.20f, 0.20f, 0.77f, 0.77f, 0.77f);
			renderer.renderStandardBlock(block, x, y, z);
			//top
			if(world.getBlock(x, y+1, z) == ModBlocks.pipe){
				renderer.setRenderBounds(0.33f, 0.66f, 0.33f, 0.66f, 1f, 0.66f);
				renderer.renderStandardBlock(block, x, y, z);
			}
			if(world.getBlock(x, y+1, z) == ModBlocks.particleAccelerator || world.getBlock(x, y+1, z) == ModBlocks.atomicPulveriser){
			...
			//left
			if(world.getBlock(x+1, y, z) == ModBlocks.pipe){
				renderer.setRenderBounds(0.33f, 0.33f, 0.33f, 1f, 0.66f, 0.66f);
				renderer.renderStandardBlock(block, x, y, z);
			}
			if(world.getBlock(x+1, y, z) == ModBlocks.particleAccelerator || world.getBlock(x+1, y, z) == ModBlocks.atomicPulveriser){
			...
			//front
			if(world.getBlock(x, y, z+1) == ModBlocks.pipe){
				renderer.setRenderBounds(0.33f, 0.33f, 0.33f, 0.66f, 0.66f, 1f);
				renderer.renderStandardBlock(block, x, y, z);
			}
			if(world.getBlock(x, y, z+1) == ModBlocks.particleAccelerator || world.getBlock(x, y, z+1) == ModBlocks.atomicPulveriser){
