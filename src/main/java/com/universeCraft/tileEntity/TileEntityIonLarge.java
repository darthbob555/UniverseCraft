...
public class TileEntityIonLarge extends TileEntity {
	
	public int storedEnergy = 0;
	public int energyCapacity = 5000000;
	...
	public void showStatus(EntityPlayer player) {
		if(worldObj.isRemote){
			float percentage = (float)(this.storedEnergy/(float)5000000*100);
			String format;
			if(percentage <= 25){
				format = "\u00A7c";
			}
			...
			player.addChatComponentMessage(new ChatComponentText(format + "Energy: " + this.storedEnergy + "/5000000SE"));
